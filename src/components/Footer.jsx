    ...
    <div>
        <div className='footer'>
            <div>
                ...
                <a href="#legal"><p>Terms of Use &nbsp; Privacy  Policy &nbsp; FAQ </p></a>
            </div>
            ...
            <div>
                ...
                <div className='emg'>
                    <img src="https://o.remove.bg/downloads/6da3e562-e93e-46f4-bfa3-b9efd2809260/png-clipart-google-play-app-store-apple-apple-text-rectangle-removebg-preview.png" alt="Get the app from Google Play or the App Store" />
